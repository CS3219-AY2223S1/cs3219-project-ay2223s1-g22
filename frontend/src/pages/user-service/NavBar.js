import { HStack, Heading, Avatar, useColorMode, Button, Popover, 
    PopoverTrigger, PopoverContent, PopoverArrow, PopoverCloseButton, PopoverBody } from "@chakra-ui/react";
...
function NavBar() {
    ...
    <HStack w="100%" px="3%" py="1%" justifyContent="space-between">
        ...
        <HStack>
            ...
            <Popover>
                <PopoverTrigger>
                    <Avatar name="Sasuke Uchiha" src="https://bit.ly/broken-link" click />
                </PopoverTrigger>
